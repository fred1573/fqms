...
<div class="container-right">
    ...
    <p>
        <c:if test="${not empty innOrderCount and innOrderCount.orders !=0}">
            截止您所选时间段内，共有<em style="color:red;">${innOrderCount.orders}</em>个订单，分销商结算总额为<em style="color:red;">${innOrderCount.ia}</em>，番茄补款金额为<em style="color:red;">${innOrderCount.replenishment}</em>，客栈结算总额为<em style="color:red;">${innOrderCount.inns}</em>，
        </c:if>
    </p>
