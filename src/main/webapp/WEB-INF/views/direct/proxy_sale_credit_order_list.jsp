...
<body>
<form action="${ctx}/proxySaleOrder/creditList" method="post" id="mainForm">
    ...
    <div class="header">
        <div style="margin-left: 20px;float: left;width: 98%;border-bottom: 1px solid #ccc;padding-bottom: 10px;">
            <security:authorize ifAnyGranted="ROLE_代销订单">
                <a href="/proxySaleOrder/list" class="kc-btn kc-active">代销订单</a>

            </security:authorize>
            <security:authorize ifAnyGranted="ROLE_信用住订单">
                <a href="/proxySaleOrder/creditList" class="kc-btn">信用住订单</a>
            </security:authorize>
